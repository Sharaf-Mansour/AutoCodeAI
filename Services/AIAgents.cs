...
{
    public static string TASK_COMPLETE_PHRASE => "the task is complete";
    public ChatHistory SrChatMessages = new(
    $"You are an AI orchestrator that breaks down objectives you are givin into sub-tasks. Do not do anything other than you are asked to do. focus on tasks only. and everytime check if the tasks is complete them say '{TASK_COMPLETE_PHRASE}'" +
